...
- [v] Create a `Dockerfile` for `notes-app.jar`.
- [v] Use `eclipse-temurin:21-jre-alpine` as base image.
- [v] In `docker-compose.yml`, define 3 services: `app`, `db` (Postgres), and `redis`.
- [v] Map port `8081` for the app.
